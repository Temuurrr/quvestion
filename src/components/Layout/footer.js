const Footer = () => {
  return (
    <footer class="w-full  flex items-center justify-center bg-indigo-600">
      <div class="max-w-5xl mx-auto px-4 text-white flex flex-col">
        <div class="w-full text-7xl font-bold pt-4">
          <h1 class="w-full md:w-2/3">The place where you can help </h1>
        </div>
        <div class="flex mt-8 flex-col md:flex-row md:justify-between">
          <p class="w-full md:w-2/3 text-gray-200 font-semibold">
        ...
        <div class="flex flex-col">
          <div class="flex mt-24 mb-12 flex-row justify-between">
            ...
            <a class="hidden md:block cursor-pointer text-gray-100 hover:text-gray-300 uppercase">
              Home
            </a>
            <a class="hidden md:block cursor-pointer text-gray-100 hover:text-gray-300 uppercase">
              Questions
          ...
          <p class="w-full text-lg text-center my-12 text-white">
